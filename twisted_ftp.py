...
class FTPRealmTwo(FTPRealm):

    def getHomeDirectory(self, avatarId):
        """Overwriting the getHomeDirectory to specify a new homedirectory for each user"""
        return FilePath(os.path.join(os.getcwd(), avatarId))

p = Portal(FTPRealmTwo(os.path.join(os.getcwd(), 'serverFiles')),
